            ...
            {favorites.map((fav, index) => (
              ...
              >
                ...
                <div className="aspect-[3/4] overflow-hidden relative">
                  ...
                  {/* Tür Etiketi (Sağ Üst) */}
                  <div className={`absolute top-2 right-2 px-2 py-1 rounded text-sm font-bold text-white uppercase tracking-wider border border-white/10 shadow-sm
                ...
                <div className="absolute bottom-0 left-0 w-full p-3">
                  ...
                  <div className="mt-2 text-sm text-gray-400 font-medium uppercase tracking-wider group-hover:text-white transition-colors flex items-center gap-1">
