...
export default function AdminLayout({
    ...
    return (
        <div className="flex h-[100dvh] max-h-[100dvh] bg-gray-100 font-sans text-gray-900 overflow-hidden fixed inset-0">
            ...
            <aside
                className={`w-64 bg-gray-900 text-white flex flex-col shadow-xl fixed inset-y-0 left-0 z-30 transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 h-full min-h-0 ${
            ...
            >
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto min-h-0">
                    ...
                    <SubNav href="/admin/webtoon-ekle?series_type=WEBTOON" label="Webtoon Ekle" onNavigate={closeSidebar} />
                    <SubNav href="/admin/webtoon-ekle?series_type=MANGA" label="Manga Ekle" onNavigate={closeSidebar} />
                    <SubNav href="/admin/bolum-ekle?series_type=WEBTOON" label="Webtoon Bölüm Ekle" onNavigate={closeSidebar} />
                    <SubNav href="/admin/bolum-ekle?series_type=MANGA" label="Manga Bölüm Ekle" onNavigate={closeSidebar} />
                    ...
                    <SubNav href="/admin/novel-ekle" label="Novel Ekle" onNavigate={closeSidebar} />
                    <SubNav href="/admin/novel-bolum-ekle" label="Novel Bölüm Ekle" onNavigate={closeSidebar} />
